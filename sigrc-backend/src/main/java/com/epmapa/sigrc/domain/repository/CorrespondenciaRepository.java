...
public interface CorrespondenciaRepository extends JpaRepository<Correspondencia, Integer> {
    ...
    @Query(value = "SELECT c.id_correspondencia, c.activo, CAST(c.asunto AS TEXT) as asunto, c.cargo, CAST(c.codigo_documento AS TEXT) as codigo_documento, c.creado_en, c.creado_por, c.departamento_remitente, c.estado, c.fecha_documento, c.fecha_limite_respuesta, c.fecha_recepcion, c.genera_ticket, c.hora_recepcion, c.institucion, CAST(c.numero_interno AS TEXT) as numero_interno, c.observaciones, c.persona_entrega, c.prioridad, c.requiere_respuesta, c.resumen_ejecutivo, c.id_responsable, c.id_tipo_documento FROM sigrc.correspondencia c WHERE c.activo = true AND " +
